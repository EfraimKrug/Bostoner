...
$iDonation = htmlentities($_POST['iDonation'],ENT_QUOTES);
...
// Update Database
$sqlInsertInfo = "INSERT INTO Info (infoPicture, infoMemory, infoName, infoDonation) VALUES ('" . $iFileName . "','" . $iMemory . "','" . $iName . "','" . $iDonation . "');";
